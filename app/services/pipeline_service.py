...
class PipelineService:
    ...
    async def run_full_pipeline(self, project_id: str) -> str:
        ...
        async with PIPELINE_SEMAPHORE:
            try:
                ...
                output_path, render_duration = await self._run_step(
                    project_id, "render",
    ...
    async def render_only(self, project_id: str) -> str:
